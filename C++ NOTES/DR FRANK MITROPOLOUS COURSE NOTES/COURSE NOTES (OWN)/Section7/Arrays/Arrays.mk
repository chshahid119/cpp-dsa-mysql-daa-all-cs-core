...
SourceSwitch           :=-c 
OutputDirectory        :=E:/C++ Notes/cpp-dsa-mysql-daa-all-cs-core/C++ NOTES/DR FRANK MITROPOLOUS COURSE NOTES/COURSE NOTES (OWN)/Section7/build-$(WorkspaceConfiguration)/bin
